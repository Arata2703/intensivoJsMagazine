import { getLocalStorage, drawProductInSimpleCart } from "./src/utilidades";
...
function criarPedidoHistorico(pedidoComData) {
    ...
    for(const idProduto in pedidoComData.pedido) {
        drawProductInSimpleCart(idProduto,  `container-pedidos-${pedidoComData.dataPedido}`, pedidoComData.pedido[idProduto]);
    }
